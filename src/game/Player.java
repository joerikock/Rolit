...
public abstract class Player {
	...
	/**
	 * Method for checking if the player has a possible move to
	 * make. This method is further implemented in the extentions 
	 * of the class Player, e.g. HumanPlayer, DumbPlayer.
	 * 
